...
# Generate random input tensor for encoder
src = torch.randint(0, vocab_size, (batch_size, seq_len))  # Random token indices

# Create source mask for self-attention (optional, used for padding masking)
...
# Step 1: Self-Attention on Source Sequence (Multi-Head Self-Attention)
